<template>
    <form action="" v-show=" ! timerStart" @submit.prevent class="form-inline">
        ...
        :
        <div class="form-group label-floating">
            <label for="form-seconds" class="control-label">Seconds</label>
    ...
    <div class="counter-container">
        <span class="counter-text" id="poker-timer" v-show="timerStart"></span>
    </div>
</template>
    ...
    export default {
        ...
        ready: function () {
            ...
            this.clock = $clock.countdown(this.timeFrom(1, 30, 0), function (event) {
                ...
                that.$dispatch('timer', that.getTimestamp(event));
                if (that.getTimestamp(event) % (30 * 60) == 0) {
                    that.beep();
                }
        ...
        methods: {
            ...
            getTimestamp: function(event) {
                return parseInt(event.strftime('%H')) * 60 * 60 + parseInt(event.strftime('%M')) * 60 + parseInt(event.strftime('%S'));
            }
        }
    }
</script>